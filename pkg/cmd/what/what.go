...
type CreateOptions struct {
	...
	VisibilityResolver func() (string, error)
...
func promptNameStrat(canPrompt bool) resolver.Strat {
	return func() (string, error) {
		if !canPrompt {
			return "", errors.New("name argument required when not running interactively")
		}
...
func promptVisibilityStrat(canPrompt bool) resolver.Strat {
	return func() (string, error) {
		if !canPrompt {
			return "", errors.New("visibility argument required when not running interactively")
		}
